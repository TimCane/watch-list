    ...
    public class Genres : IGenres
    {
        ...
        private static readonly Dictionary<string, IOrderBy> OrderFunctions =
            new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "Name", new OrderBy<DbGenre,string>(x => x.Name) },
                { "CreatedOn", new OrderBy<DbGenre,DateTime>(x => x.CreatedOn) },
                { "ModifiedOn", new OrderBy<DbGenre,DateTime>(x => x.ModifiedOn) },
                { "CreatedBy", new OrderBy<DbGenre,Guid>(x => x.CreatedBy) },
                { "ModifiedBy", new OrderBy<DbGenre,Guid>(x => x.ModifiedBy) },
            };
